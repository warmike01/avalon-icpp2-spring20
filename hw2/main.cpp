...
int main()
  ...
  for(int k=0; k<temp; k++) 
  {
    ...
    cout << endl;
         printf("Чтобы стать лучше 25%% студентов, нужно получить оценку %d \n", List[25].Mark+1);
          printf("Чтобы стать лучше 50%% студентов, нужно получить оценку %d \n", List[49].Mark+1);
           printf("Чтобы стать лучше 75%% студентов, нужно получить оценку %d \n", List[74].Mark>=5? List[74].Mark : List[74].Mark+1);
     }
